...
export default function ReservationScreen({ route }) {
  ...
  console.log("Hello");
  console.log("asdasd",accepetedReservation);
  console.log(reservationInformation);
  const handleReservation = async () => {
    if (reservationInformation !== null || accepetedReservation !== null) {
      Alert.alert(
        "Reservation Limit",
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        {reservationInformation || accepetedReservation ? (
          <View>
       ...
       {" "}Floor
            ...
            <Text style={styles.infoText2}>
              Total Amount:{" "}
              {reservationInformation?.parkingPay ??
                userInformation?.reservationInformation.parkingPay}
              .00
            </Text>
          </View>
        ) : slotDetails ? (
